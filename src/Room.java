...
public class Room {
    ...
    private static Vector3f cameraPosition = new Vector3f(0f, 1.6f, 0f); // Center of the room
    private static String floorTexture = "img/room/floor.jpg";
    private static String wallTexture = "img/room/wall.jpg";
    ...
    public static void main(String[] args) {
        ...
        scene.addChild(createWall(new Vector3f(0f, 2.5f, -5f), 10f, 5f, 0.1f)); // Back wall
        scene.addChild(createWall(new Vector3f(5f, 2.5f, 0f), 0.1f, 5f, 10f));  // Right wall
        scene.addChild(createWall(new Vector3f(-5f, 2.5f, 0f), 0.1f, 5f, 10f)); // Left wall
        scene.addChild(createWall(new Vector3f(0f, 2.5f, 5f), 10f, 5f, 0.1f));  // Front wall
        scene.addChild(createCeiling(new Vector3f(0f, 5f, 0f), 10f, 0.1f, 10f)); // Ceiling
        addLighting(scene);
    ...
    private static TransformGroup createFloor() {
    ...
    private static TransformGroup createWall(Vector3f position, float width, float height, float depth) {
        TransformGroup tg = new TransformGroup();
    ...
    private static TransformGroup createCeiling(Vector3f position, float width, float height, float depth) {
        TransformGroup tg = new TransformGroup();
